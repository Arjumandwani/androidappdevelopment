...
import 'package:ecommercewebsite/favourites.dart';
import 'package:ecommercewebsite/streetclothes.dart';
         ...
         child: Row(children:[Text("about the product",style: SameTextStyle.heading)]),
          ...
          Container(
              child: Padding(
                padding: const EdgeInsets.all(16.0),
                child: TextField(
                maxLines: 3, // Adjust the number of lines based on your preference
