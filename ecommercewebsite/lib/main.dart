import 'package:ecommercewebsite/login.dart';import 'package:flutter/material.dart';
                ...
                if(value==null || value.trim().isEmpty)
                {
                  ...
                  SizedBox(height:16),
                    ...
                    Row(
                      ...
                      Container(child: IconButton(icon: Icon(Icons.arrow_forward,color:Colors.red,), onPressed: () { Navigator.push(context,MaterialPageRoute(builder:(context)=> MyLoginPage(title: 'login',)));
                      })),
                    ],),
                    SizedBox(height:16),
